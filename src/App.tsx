...
export default function App() {
  ...
  return (
    <main className="h-screen w-screen overflow-hidden flex flex-col relative text-white">
      {/* Background Layer with Mistral Ocean Background */}
      <div className="ocean-bg">
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <div 
            key={`orb-${i}`}
            className="absolute rounded-full bg-gradient-to-br from-rose-300/20 to-orange-200/10 blur-sm animate-pulse"
            style={{
        ...
        {/* Subtle Wave Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-teal-500/5 to-rose-400/10 animate-pulse" 
